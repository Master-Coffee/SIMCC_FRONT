                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="hidden items-center gap-2 md:ml-auto md:flex">
                    <TabsList>
                      ...
                      <TabsTrigger
                        disabled={!has_visualizar_indicadores_pos_graduacao}
                        value="ind"
                        onClick={() => setTab("ind")}
                        className="text-zinc-600 dark:text-zinc-200"
                      >
                    ...
                    {has_editar_informacoes_programa && (
                      <Sheet open={isOpenSheet} onOpenChange={setIsOpenSheet}>
                        ...
                        <SheetContent
                          className={`p-0 dark:bg-neutral-900 dark:border-gray-600 ${
                            expand ? "min-w-[80vw]" : "min-w-[50vw]"
                          }`}
                        >
                          <Tabs
                            defaultValue={tab2}
                      ...
                      <div className="mb-4 md:mb-8">
                        <div
                          className={`h-3 w-full rounded-t-md dark:border-neutral-800 border border-neutral-200 border-b-0 ${
                            qualisColor[
                              props.type.trim() as keyof typeof qualisColor
                            ]
                          }  `}
                        ></div>
                          ...
                          <CardHeader className="flex flex-row items-start bg-neutral-100 dark:bg-neutral-800">
                            <div className="flex items-center justify-between w-full">
                              ...
                              <div className="flex gap-4 items-center justify-end flex-wrap ">
                                <Link to={props.site} target="_blank">
                                  <div className="text-sm text-gray-500 dark:text-gray-300 font-normal flex gap-1 items-center">
                                    <Globe size={16} /> {props.site}
                                  </div>
                                </Link>
                              </div>
                            </div>
