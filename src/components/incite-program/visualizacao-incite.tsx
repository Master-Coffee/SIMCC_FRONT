...
export function VisualizacaoIncite() {
  ...
  const urlGraduateProgram = `${urlGeral}incite_program_profnit?id=${type_search}`;
  useEffect(() => {
  ...
  const urlTotalProgram = `${urlGeral}incite_program_production?incite_program_id=${type_search}&year=1900`;
  useEffect(() => {
  ...
  const urlDados = `${urlGeral}InciteResearcherData/DadosGerais?year=${year}&incite_program_id=${type_search}`;
  ...
  let urlPalavrasChaves = `${urlGeral}incite_lists_word_researcher?incite_program_id=${type_search}&researcher_id=`;
  ...
  // [○] incite_graduate_program_id : incitePrograms
  const incite_graduate_program_id =
    incitePrograms && incitePrograms[0]
      ? incitePrograms[0].incite_graduate_program_id
      : null;
  ...
  return (
    <>
      {/* // [○] incitePrograms */}
      {incitePrograms.slice(0, 1).map((props) =>
        props.visible === "false" ? (
          <div
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          >
                            <Button
                              ...
                              onClick={() => onOpen("researchers-home")}
                            >
                          ...
                          <div
                            onClick={() => onOpen("institutions-home")}
                          ></div>
                        </div>
                        <div>
                          <Button
                  ...
                  <div className="md:p-8 p-4 py-0 md:py-0">
                    ...
                    {incitePrograms.slice(0, 1).map((props) => (
                      <div className="mb-4 md:mb-8">
                        <div
                          className={
                            "h-3 w-full rounded-t-md dark:border-neutral-800 border border-neutral-200 border-b-0 bg-green-900"
                          }
                        ></div>
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <TooltipProvider>
                                    <Tooltip>
                                      ...
                                      <TooltipContent>
                                        <p>
                                          Essas informações não representam a
                                          produção total da Escola desde a sua
                                          fundação, é um recorte a partir de{" "}
                                          {year}
                                        </p>
                                      </TooltipContent>
                                    </Tooltip>
                              ...
                              {[
                                ...
                                return (
                                  <button
                                    ...
                                    className={`relative flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-left even:border-l data-[active=true]:bg-muted/50 sm:border-l sm:border-t-0 dark:border-l-neutral-800 sm:px-8 sm:py-6 ${
                                      activeChart === chart &&
                          ...
                          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p>
                                    Fonte: Plataforma Lattes e Sucupira Qualis
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
