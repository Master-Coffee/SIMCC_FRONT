      ...
      <TooltipProvider delayDuration={0}>
        ...
        >
          <ResizablePanel
            ...
            onExpand={() => {
              // Função para expandir também sem parâmetros
          ...
          >
            <div>
              <div
                className={cn(
                  "flex h-[50px] gap-1 items-center justify-center border-b border-b-neutral-200 dark:border-b-neutral-800",
              ...
              <NavigationSidebar isCollapsed={isCollapsed} links={links2} />
            </div>

            <div className="flex flex-col ">
              <NavigationSidebar isCollapsed={isCollapsed} links={links3} />
            </div>
          </ResizablePanel>
        ...
        <DialogContent className="p-0">
          ...
          <DialogHeader className="p-6">
            <DialogTitle className="text-2xl font-medium">
              Apresentamos a plataforma {version ? "Conectee" : "Iapós"}
            </DialogTitle>
            <DialogDescription>
              O jeito mais fácil de visualizar e filtrar as produções técnicas e
              bibliográficas dos pesquisadores{" "}
              {version ? "da Escola de Engenharia da UFMG" : "do SENAI CIMATEC"}
              .
            </DialogDescription>
