...
function App() {
  ...
  const [version, setVersion] = useState(
    import.meta.env.VITE_VERSION == "false" ? false : true
  );
  ...
  return (
    <>
            ...
            <DefaultLayout>
              <LoadingWrapper>
                <Routes>
                  ...
                  {/* // [ROUTE] incite */}
                  <Route path="/incite" element={<Home />} />
                  ...
                  <Route
                    path="/pesquisadores-selecionados"
                    element={<Home />}
                  />
                  ...
                  <Route
                    path="/dashboard/relatar-problema"
                    element={<Dashboard />}
                  />
                  <Route
                    path="/dashboard/pesquisadores-selecionados"
                    element={<Dashboard />}
                  />
      ...
      */}
                  ...
                  <Route
                    path="/minhaufmg/dashboard/informacoes"
                    element={<Dashboard />}
                  />
